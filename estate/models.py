...
class Buy_Sell_Home(models.Model):
    ...
    area_code = models.CharField(max_length=100, verbose_name=_('Area Code'))
    date = models.CharField(max_length=200, verbose_name=_(
        'Date'), null=True, blank=True)
    owner_name = models.CharField(
        max_length=200, verbose_name=_('Owner Name'), null=True, blank=True)
    owner_phone = models.CharField(
        max_length=11, verbose_name=_('Owner Phone'), null=True, blank=True)
    street = models.CharField(
        max_length=500, verbose_name=_('Street'), null=True, blank=True)
    plaque = models.CharField(
        max_length=100, verbose_name=_('Plaque'), null=True, blank=True)
    floors = models.CharField(
        max_length=100, verbose_name=_('Floors'), null=True, blank=True)
    ...
    customer_name = models.CharField(
        max_length=200, verbose_name=_('Customer Name'), null=True, blank=True)
    style = models.CharField(
        max_length=200, verbose_name=_('Style'), null=True, blank=True)
    heating = models.CharField(
        max_length=200, verbose_name=_('Heating'), null=True, blank=True)
    bottom = models.CharField(
        max_length=200, verbose_name=_('Bottom'), null=True, blank=True)
    electricity = models.CharField(
        max_length=200, verbose_name=_('Electricity'), null=True, blank=True)
    kitchen = models.CharField(
        max_length=200, verbose_name=_('Kitchen'), null=True, blank=True)
    faucets = models.CharField(
        max_length=200, verbose_name=_('Faucets'), null=True, blank=True)
    bathtub = models.CharField(
        max_length=200, verbose_name=_('Bathtub'), null=True, blank=True)
    window = models.CharField(
        max_length=200, verbose_name=_('Window'), null=True, blank=True)
